    ...
    <div>
        ...
        <div class="bg-white">
                    ...
                    <div class="fixed inset-0 z-40 flex">
                        <TransitionChild as="template" enter="transition ease-in-out duration-300 transform" enter-from="-translate-x-full" enter-to="translate-x-0" leave="transition ease-in-out duration-300 transform" leave-from="translate-x-0" leave-to="-translate-x-full">
                            <DialogPanel class="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                                ...
                                <div class="space-y-6 border-t border-gray-200 py-6 px-4" v-if="!$page.props.user">
                                    <div class="flow-root">
                                        <Link :href="route('register')" class="inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 w-full">Utwórz konto</Link>
                                    </div>
                                    <div class="flow-root">
                                        Jesteś już naszym klientem?
                                        <Link :href="route('login')" class="whitespace-nowrap font-medium text-orange-500 hover:text-orange-600 text-sm">Zaloguj się</Link>
                                    </div>
                                </div>
                            </DialogPanel>
                        </TransitionChild>
            ...
            <header class="relative bg-white">
                <p class="flex h-10 items-center justify-center bg-orange-400 px-4 text-sm font-medium text-gray-900 sm:px-6 lg:px-8">Darmowa dostawa dla zamówień powyżej 99 zł</p>
...
<!--                                </div>-->
                                ...
                                <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0" v-if="!$page.props.user">
                                    <Link :href="route('login')" class="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">Zaloguj się</Link>
                                    <Link :href="route('register')" class="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700">Utwórz konto</Link>
                                </div>
                                <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0" v-else>
                                    <!-- Settings Dropdown -->
