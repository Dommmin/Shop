                ...
                <div class="mx-auto py-6 sm:px-6 lg:px-8">
                    <div class="px-4 py-6 sm:px-0">
                        ...
                        <div class="flex justify-end mb-4">
                            <Link class="bg-violet-500 hover:bg-violet-600 px-4 py-2 rounded-xl text-white" :href="route('category.create')">
                                <span>Dodaj</span>
                        ...
                        <div class="bg-white rounded-md shadow overflow-x-auto">
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody>
                                <tr v-for="category in categories" class="hover:bg-sky-200 bg-sky-100">
                                    <td class="border-t">
