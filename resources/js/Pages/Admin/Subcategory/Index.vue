                ...
                <div class="mx-auto py-6 sm:px-6 lg:px-8">
                    <div class="px-4 py-6 sm:px-0">
                        ...
                        <div class="flex justify-end mb-4">
                            <Link class="bg-emerald-500 hover:bg-emerald-600 px-4 py-2 rounded-xl text-white" :href="route('subcategory.create')">
                                <span>Dodaj</span>
                                <span class="hidden md:inline"> podkategorię</span>
                            </Link>
                        </div>
                        ...
                        <div class="bg-white rounded-md shadow overflow-x-auto">
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody>
                                <tr v-for="subcategory in subcategories" class="hover:bg-sky-200 bg-sky-100">
                                    <td class="border-t">
                                    ...
                                    <td class="border-t">
                                        <a href="#" @click="destroy(subcategory.id)" class="flex items-center px-6 py-4" title="Usuń">
...
const destroy = (id) => {
    if (confirm('Are you sure?')) {
        Inertia.delete(route('subcategory.destroy', id));
    }
};
