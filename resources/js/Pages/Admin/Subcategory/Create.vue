        ...
        <div class="py-2">
            <div class="sm:px-6 lg:px-8 bg-gray-100">
                <div class="mx-auto py-6 sm:px-6 lg:px-8 max-w-[50rem]">
                    ...
                    <form @submit.prevent="form.post(route('subcategory.store'))">
                        <div class="overflow-hidden shadow sm:rounded-md">
                            ...
                            <div class="m-4">
                                <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Kategoria</label>
                                <select v-model="form.category_id" name="category" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
