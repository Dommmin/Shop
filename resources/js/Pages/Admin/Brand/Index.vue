                ...
                <div class="mx-auto py-6 sm:px-6 lg:px-8">
                    <div class="px-4 py-6 sm:px-0">
                        ...
                        <div class="flex justify-end mb-4">
                            <Link class="bg-amber-500 hover:bg-amber-600 px-4 py-2 rounded-xl text-white" :href="route('brand.create')">
                                <span>Dodaj</span>
                        ...
                        <div class="bg-white rounded-md shadow overflow-x-auto text-white">
                            <table class="w-full whitespace-nowrap">
                                ...
                                <tbody>
                                <tr v-for="brand in brands" class="hover:bg-sky-200 text-black bg-sky-100">
                                    <td class="border-t">
...
const destroy = (id) => {
    if (confirm('Are you sure?')) {
        Inertia.delete(route('brand.destroy', id));
    }
};
